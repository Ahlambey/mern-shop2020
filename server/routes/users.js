...
router.post("/successBuy", auth, (req, res) => {
  ...
  // 1.put brief payment information inside user collect
  ...
  User.findOneAndUpdate(
    ...
    (err, user) => {
      ...
      payment.save((err, doc) => {
        ...
        // 3. increase amount of number for the sold information
        // first we need to know how many products were sold in this transaction for each of the products
        let products = [];
...
router.get('/getHisotry', auth, (req, res)=>{
  User.findOne(
    {_id: req.user._id},
    (err, doc)=>{
